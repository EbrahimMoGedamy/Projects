...
//        swilizeLocalizedMethod(UIApplication.self, originalSelector: #selector(getter: UIApplication.userInterfaceLayoutDirection),
//                                    overrideSelector: #selector(getter: UIApplication.customuserInterface))
    }
}
